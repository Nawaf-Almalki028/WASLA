...
urlpatterns = [
    ...
    path('teams/<hackathon_id>/<track_id>', views.dashboard_track_teams_view, name="dashboard_track_teams_view"),
    path('hackathons/add_track/<hackathon_id>', views.dashboard_add_track_view, name="dashboard_add_track_view"),
    path('hackathons/add_requirement/<hackathon_id>', views.dashboard_add_requirement_view, name="dashboard_add_requirement_view"),
