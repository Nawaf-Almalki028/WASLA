...
def dashboard_home_view(request:HttpRequest):
    ...
    number_of_waiting_requests = models.Team.objects.filter(Q(status=models.HackathonTeamStatusChoices.WAITING) and Q(hackathon__organization=request.user)).count()
